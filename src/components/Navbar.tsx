    ...
    <nav className="fixed top-0 left-0 right-0 z-50 py-4" style={{ backgroundColor: 'var(--color-primary)' }}>
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        ...
        <ul className="hidden md:flex gap-8 list-none">
          ...
          <li><Link href="#how-it-works" className="font-medium text-white/90 hover:text-amber-400 transition-colors">How It Works</Link></li>
      ...
      {mobileOpen && (
        <div className="md:hidden px-6 py-4 border-t border-white/10" style={{ backgroundColor: 'var(--color-primary)' }}>
          <ul className="flex flex-col gap-4">
            ...
            <li><Link href="#how-it-works" className="block text-white/90 hover:text-amber-400" onClick={() => setMobileOpen(false)}>How It Works</Link></li>
