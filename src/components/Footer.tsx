    ...
    <footer className="text-white py-12 md:py-16" style={{ backgroundColor: 'var(--color-primary-dark)' }}>
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="border-t border-white/10 pt-6 mb-6 flex justify-center gap-6">
          ...
          <a href="https://www.instagram.com/azgari.lipshy/" target="_blank" rel="noopener" className="text-white/60 hover:text-amber-400 transition-colors text-sm">Instagram</a>
          <a href="https://www.linkedin.com/company/azgari" target="_blank" rel="noopener" className="text-white/60 hover:text-amber-400 transition-colors text-sm">LinkedIn</a>
